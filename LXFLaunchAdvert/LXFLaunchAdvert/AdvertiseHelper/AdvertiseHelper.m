...
+ (void)showAdvertiserView:(NSArray *)imageArray andShowTime:(NSInteger)time {
    ...
    if (isExist) {// 图片存在
        ...
        AdvertiseView *advertiseView = [[AdvertiseView alloc] initWithFrame:kAdMain_Screen_Bounds andTime:time];
        advertiseView.filePath = filePath;
        [advertiseView showWithShowTime:time];
